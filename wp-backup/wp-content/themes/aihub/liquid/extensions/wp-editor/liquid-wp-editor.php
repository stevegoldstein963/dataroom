...
class Liquid_Wp_Editor extends Liquid_Base {
	...
	public function liquid_styles_dropdown( $settings ) {
		...
		$new_styles = array(
			array(
				'title'    => esc_html__( 'Add Dropcap', 'aihub' ),
				'selector' => 'p',
				'classes' => 'add-dropcap',
				'wrapper' => true,
			),
			array(
				'title'	 => esc_html__( 'Highlight', 'aihub' ),
				'selector' => '',
				'wrapper' => true,
			),
			array(
				'title'	=> esc_html__( 'Text Transform', 'aihub' ),
				'items'	=> array(
					array(
						'title'		=> esc_html__( 'Uppercase', 'aihub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'uppercase' ),
					),
					array(
						'title'		=> esc_html__( 'Lowercase', 'aihub' ),
						'inline'	=> 'span',
						'styles'    => array( 'text-transform' => 'lowercase' ),
					),
					array(
						'title'		=> esc_html__( 'Capitalize', 'aihub' ),
						'inline'	=> 'span',
			...
			array(
	            'title'    => esc_html__( 'Reset List', 'aihub' ),
	            'selector' => 'ul',
	            'classes'  => 'list-none p-0 m-0',
				'wrapper' => true,
	        ),
			array(
	            'title'    => esc_html__( 'Inline List', 'aihub' ),
	            'selector' => 'ul',
				'classes'  => 'list-none p-0 m-0 flex flex-wrap items-center'
	        ),
		);
