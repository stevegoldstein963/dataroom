...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-font-start">
	<a href="#">
...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-font-end">
	<a href="#">
		<span>{{ data.title }}</span>
		<i class="_icon {{ data.type }} {{ data.icon }} _{{ data.position }}"
			style="font-size:{{ data.font_size }}em; vertical-align:{{ data.vertical_align }};"
...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-image-start">
	<a href="#">
		<img src="{{ data.url }}"
			alt="{{ data.alt }}"
...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-image-end">
	<a href="#">
		<span>{{ data.title }}</span>
		<img src="{{ data.url }}"
			alt="{{ data.alt }}"
...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-svg-start">
	<a href="#">
		<img src="{{ data.url }}"
			alt="{{ data.alt }}"
...
<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-svg-end">
	<a href="#">
		<span>{{ data.title }}</span>
		<img src="{{ data.url }}"
			alt="{{ data.alt }}"
