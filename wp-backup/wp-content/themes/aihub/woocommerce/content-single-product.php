...
$single_product_style = get_post_meta( get_the_ID(), 'liqud_product_page_style', true );
...
$cols_img_classes     = 'w-8/12 mobile-extra:w-7/12 mobile:w-full';
$cols_summary_classes = 'w-4/12 mobile-extra:w-5/12 mobile:w-full';
$summary_info_classes = 'lqd-woo-summary-info d-md-flex flex-wrap items-md-center justify-md-between';
...
elseif( '2' === $single_product_style ) {
	...
	$cols_img_classes     = 'w-7/12 mobile-extra:w-6/12 mobile:w-full';
	$cols_summary_classes = 'w-5/12 mobile-extra:w-6/12 mobile:w-full';
...
<div class="woocommerce-message lqd-woo-added-msg" style="display:none;">
	<span class="lqd-woo-msg-adding">
		<?php esc_html_e( 'Adding product to the cart!', 'aihub' ); ?>
	</span>
	<span class="lqd-woo-msg-added">
		<?php esc_html_e( 'Added to the cart!', 'aihub' ); ?>
	</span>
</div>
