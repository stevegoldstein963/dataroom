...
<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
	<thead>
		<tr>
			<th class="product-img"><?php esc_html_e( 'Product', 'aihub' ); ?> <?php echo '('.count(WC()->cart->get_cart()).')'; ?></th>
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-img" data-title="<?php esc_attr_e( 'Product', 'aihub' ); ?>">
						<?php
		...
		<tr>
			<td colspan="3" class="cart-coupon">
				...
				<span class="cart-coupon-inner">
					...
					<form class="checkout_coupon" method="post">
						...
						<button type="submit" class="button apply_coupon" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'aihub' ); ?>">
			...
			<td colspan="5" class="actions">
				...
				<div class="woo-actions-inner">
					...
					<button type="submit" class="button update_cart <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'aihub' ); ?>">
