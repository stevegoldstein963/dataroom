	...
	<div class="w-full mx-auto text-center">
		<section class="no-results not-found">
			<header class="page-header">
				<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'aihub' ); ?></h1>
			</header>
			...
			<div class="page-content">
				...
				<?php elseif ( is_search() ) : ?>
					...
					<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'aihub' ); ?></p>
					<?php get_search_form(); ?>
