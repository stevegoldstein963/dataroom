...
?>
<div class="ld-module-search lqd-module-search-frame flex items-center" data-module-style='lqd-search-style-frame' >
	...
	<div class="ld-module-dropdown collapse flex flex-col items-center justify-center fixed pos-tl text-center pointer-events-none" id="<?php echo esc_attr( $search_id ) ?>" aria-expanded="false">

		<div class="ld-search-form-container">

			<span class="lqd-module-search-close input-icon inline-block absolute" aria-label="Close search form" data-ld-toggle="true" data-toggle="collapse" data-target="<?php echo '#' . esc_attr( $search_id ); ?>" aria-controls="<?php echo esc_attr( $search_id ) ?>" aria-expanded="false"><i class="lqd-icn-ess icon-ion-ios-close"></i></span>
			...
			<div class="lqd-module-search-related flex mx-auto mt-0 mb-0">
