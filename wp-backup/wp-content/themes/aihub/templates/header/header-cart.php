...
<div class="ld-module-cart ld-module-cart-dropdown flex items-center">
	...
	<div class="ld-module-dropdown collapse absolute" id="<?php echo esc_attr( $cart_id ) ?>" aria-expanded="false">
