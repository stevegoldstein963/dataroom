...
<div class="ld-module-cart ld-module-cart-offcanvas flex items-center">
	...
	<div class="ld-module-dropdown ld-module-cart-offcanvas-dropdown collapse d-block absolute will-change-transform" id="<?php echo esc_attr( $cart_id ); ?>" aria-expanded="false">
		<div class="ld-cart-contents h-vh-full">

			<div class="header-quickcart flex flex-wrap">
