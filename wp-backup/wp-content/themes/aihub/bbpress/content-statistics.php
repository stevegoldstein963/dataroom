...
<dl role="main">
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php _e( 'Empty Topic Tags', 'aihub' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Topics', 'aihub' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Replies', 'aihub' ); ?></dt>
		<dd>
			<strong>
