...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php _e( 'Log In', 'aihub' ); ?></legend>
		...
		<div class="bbp-password">
			<label for="user_pass"><?php _e( 'Password', 'aihub' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php _e( 'Keep me signed in', 'aihub' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit"><?php _e( 'Log In', 'aihub' ); ?></button>
