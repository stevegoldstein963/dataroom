...
class LQD_Woo_Product_Upsell extends Widget_Base {

	public function get_name() {
		return 'lqd-woo-product-upsell';
	}

	public function get_title() {
		return __( 'Liquid Product Upsell', 'aihub-core' );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register( new LQD_Woo_Product_Upsell() );