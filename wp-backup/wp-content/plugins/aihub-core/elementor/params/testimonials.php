...
class LQD_Elementor_Render_Testimonial {

    function ld_testi_get_classes( $style ) {

        $hash = array(
            'style01' => 'lqd-testi-style-1 flex flex-col-reverse lqd-testi-card lqd-testi-shadow-xs lqd-testi-details-lg lqd-testi-quote-18 lqd-testi-avatar-72',
            'style02' => 'lqd-testi-style-2 flex flex-col lqd-testi-card lqd-testi-shadow-none lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-60 lqd-testi-bubble-all',
            'style03' => 'lqd-testi-style-3 flex flex-col lqd-testi-card lqd-testi-shadow-xs lqd-testi-quote-21 lqd-testi-avatar-60',
            'style04' => 'lqd-testi-style-4 flex flex-row-reverse lqd-testi-card lqd-testi-shadow-xxl lqd-testi-quote-15 lqd-testi-avatar-65',
            'style05' => 'lqd-testi-style-5 flex flex-col lqd-testi-card lqd-testi-details-sm lqd-testi-quote-22 lqd-testi-avatar-48',
            'style06' => 'lqd-testi-style-6 flex flex-col lqd-testi-card lqd-testi-details-sm lqd-testi-quote-21 lqd-testi-avatar-48 pt-6 pb-6 text-center',
            'style07' => 'lqd-testi-style-7 flex flex-wrap lqd-testi-card lqd-testi-card-nospace lqd-testi-shadow-lg lqd-testi-quote-21',
            'style08' => 'lqd-testi-style-8 flex flex-col-reverse lqd-testi-card lqd-testi-shadow-none lqd-testi-details-sm lqd-testi-quote-16 lqd-testi-avatar-48',
            'style09' => 'lqd-testi-style-9 flex flex-col-reverse lqd-testi-brd rounded-4 lqd-testi-details-sm lqd-testi-quote-16 lqd-testi-avatar-48',
            'style10' => 'lqd-testi-style-10 flex flex-col lqd-testi-card lqd-testi-shadow-none lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-65 text-center',
            'style11' => 'lqd-testi-style-11 flex flex-col lqd-testi-card lqd-testi-shadow-sm lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-48 text-center',
            'style12' => 'lqd-testi-style-12 lqd-testi-quote-18 lqd-testi-avatar-65',
            'style13' => 'lqd-testi-style-13 flex flex-wrap lqd-testi-details-sm lqd-testi-quote-25 lqd-testi-avatar-72',
            'style14' => 'lqd-testi-style-14 flex flex-col-reverse lqd-testi-details-xl lqd-testi-quote-22 lqd-testi-avatar-90',
            'style15' => 'lqd-testi-style-15 flex flex-wrap lqd-testi-bubble rounded-4 lqd-testi-details-lg lqd-testi-quote-25',
            'style16' => 'lqd-testi-style-16 flex flex-wrap lqd-testi-card lqd-testi-card-nospace lqd-testi-shadow-xl lqd-testi-quote-27',
            ...
            'style19' => 'lqd-testi-style-19 flex flex-col lqd-testi-card lqd-testi-shadow-sm lqd-testi-details-same lqd-testi-details-inline lqd-testi-quote-18 lqd-testi-avatar-60',
        );
    ...
    function ld_testi_get_avatar( $classnames, $style, $avatar, $title ) {
        ...
        if( preg_match( '/^\d+$/', $avatar['url'] ) ){
            ...
            if( 'style07' === $style || 'style16' === $style ) {
                $out = wp_get_attachment_image( $avatar['id'], 'full', false, array( 'alt' => esc_html( $alt ), 'class' => 'w-full h-full flex-grow-1 objfit-cover objpos-center' ) );
            }
            else {
            ...
            if( 'style07' === $style || 'style16' === $style ) {
                $out = sprintf( '<img class="w-full h-full flex-grow-1 objfit-cover objpos-center" src="%s" alt="%s" />', $out, esc_html( $alt ) );
            }
            else {
                // Default
                $out = sprintf( '<img class="rounded-full" src="%s" alt="%s" />', $out, esc_html( $alt ) );
            }
        }

        if( 'style07' === $style || 'style16' === $style ) {
            $out = sprintf( '<figure class="lqd-testi-avatar flex w-full m-0">%s</figure>', $out );
        }
        else {
            // Default
        ...
        switch ($style){
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info flex flex-wrap justify-between mb-3">

                        <div class="lqd-testi-details flex items-center">
                            <?php $this->ld_testi_get_avatar( 'rounded-full overflow-hidden', $style, $avatar, $title) ?>
                            <div class="lqd-testi-np ps-4">
                                <?php $this->ld_testi_get_name( 'h3', null, $title ) ?>
                                <?php $this->ld_testi_get_position( 'h4', 'font-light', $position ) ?>
                            </div>
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info flex flex-wrap items-center justify-between">
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="flex flex-col flex-grow-1 ps-4">

                        <div class="lqd-testi-info flex flex-wrap items-center justify-between mb-2">
                            <div class="lqd-testi-np">
                                <?php $this->ld_testi_get_name( 'h3', 'font-medium', $title ) ?>
                            </div>
                            <?php $this->ld_testi_get_social_icon( $network ); ?>
                        </div>
                        ...
                        <div class="lqd-testi-details flex items-center">
                            <?php $this->ld_testi_get_time( 'font-medium', $time ); ?>
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info flex flex-wrap justify-center pb-3">
                        <div class="lqd-testi-details flex items-center">
                            <?php $this->ld_testi_get_avatar( 'rounded-full overflow-hidden', $style, $avatar, $title ) ?>
                            <div class="lqd-testi-np ps-4">
                                <?php $this->ld_testi_get_name( 'h3', null, $title ) ?>
            ...
            ?>
                ...
                <div class="lqd-testi-details flex w-40">
                    <?php $this->ld_testi_get_avatar( null, $style, $avatar, $title ); ?>
                </div>

                <div class="flex flex-col justify-center w-60 pt-5 pb-5 ps-6 pe-6">
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info flex flex-wrap items-center justify-between mb-4">
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info flex flex-wrap ps-4 pe-4 pt-3 pb-3">

                        <div class="lqd-testi-details flex flex-wrap flex-row-reverse items-center justify-between w-full">
                            <?php $this->ld_testi_get_avatar( 'ms-0 me-0 rounded-full overflow-hidden', $style, $avatar, $title ) ?>
                            <div class="lqd-testi-np">
                                <?php $this->ld_testi_get_name( 'h3', 'font-medium', $title ) ?>
                                <?php $this->ld_testi_get_position( 'h4', null, $position ) ?>
                            </div>
            ...
            ?>
                ...
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-info mb-1">
                        ...
                        <div class="lqd-testi-details flex flex-col items-center">
                            <?php $this->ld_testi_get_avatar( 'ms-0 me-0 rounded-full overflow-hidden', $style, $avatar, $title ) ?>
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-side lqd-testi-left lqd-testi-details flex w-full">
                        <?php $this->ld_testi_get_avatar( null, $style, $avatar, $title ); ?>
                    </div>

                    <div class="lqd-testi-side lqd-testi-right flex flex-col justify-center w-full p-5">
                        ...
                        <div class="lqd-testi-info mb-5">
                            <div class="lqd-testi-details flex items-center">
                                <div class="lqd-testi-np">
                                    <?php $this->ld_testi_get_name( 'h3', 'font-medium', $title) ?>
                                    <?php $this->ld_testi_get_position( 'h4', 'font-regular', $position ) ?>
                                </div>
                            </div>
                        </div>
            ...
            ?>
                <div class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
                    ...
                    <div class="lqd-testi-quote relative p-6">
                        <?php $this->ld_testi_get_quote( $quote ); ?>
                    </div>

                    <div class="lqd-testi-details flex flex-col items-center mt-6">

                        <?php $this->ld_testi_get_avatar( 'rounded-full overflow-hidden ms-0 me-0', $style, $avatar, $title ); ?>
                        <div class="lqd-testi-np mt-2">
                            <?php $this->ld_testi_get_name( 'h3', 'font-bold', $title ) ?>
                            <?php $this->ld_testi_get_position( 'h4', 'font-bold uppercase ltr-sp-100', $position ) ?>
                        </div>
                    ...
                    <div class="lqd-testi-info flex flex-col flex-wrap justify-between">
                        ...
                        <div class="lqd-testi-details flex items-center justify-center">
                            ...
                            <div class="lqd-testi-np text-start ps-4">
                                <?php $this->ld_testi_get_name( 'h3', 'uppercase ltr-sp-100 font-bold', $title ) ?>
                                <?php $this->ld_testi_get_position( 'h4', null, $position ) ?>
                            </div>
