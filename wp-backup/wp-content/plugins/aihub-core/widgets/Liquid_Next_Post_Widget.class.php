	...
	function widget( $args, $instance ) {
		...
		<article class="relative">
			...
			<span class="ld_entries_contents">
				...
				<a href="<?php echo get_category_link( $category_detail[0]->term_id ); ?>" class="ld_entries_cat uppercase ltr-sp-100 relative z-2"><?php echo $category_detail[0]->cat_name; ?></a>
				<?php } ?>
				<span class="ld_entries_title h2"><?php echo get_the_title( $next_post_id ); ?></span>
			</span><!-- /.contents -->

			<a href="<?php echo  get_permalink( $next_post_id ); ?>" class="absolute top-0 start-0"></a>
